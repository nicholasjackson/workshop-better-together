...
Its location was revealed in the previous task from Blackbeard’s treasure chest—refer back to your notes to find the server address.
...
* Hint: You will need to set the ansible_host variable to the server address retrieved from Blackbeard’s treasure chest and set ansible_port to 22 for SSH access.
...
* Locate and review your job to check the status and output: 
    ...
    - Debug output confirms the Minecraft server’s access list was updated, granting your team access.
