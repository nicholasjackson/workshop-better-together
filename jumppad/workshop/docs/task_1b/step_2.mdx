...
Let's create a user for your Minecraft user in the `userpassf' authentication method.

```bash
vault write -ns=admin/<your team> /auth/userpass/users/<minecraft user lowercase> password='<minecraft uuid>'
```
