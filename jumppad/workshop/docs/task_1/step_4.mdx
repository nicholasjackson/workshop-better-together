...
3. Equip your **spyglass** (can be found in the barrel on the ship).
4. Scan the horizon for a **tavern-like structure** with 🏮**lanterns**🏮 lighting a dock.
