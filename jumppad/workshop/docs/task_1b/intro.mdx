...
* ✅ Create a new user and set a password for your Minecraft account.
* ✅ Create a Vault policy to control access to the tavern_key secret.
* ✅ Assign the policy to your Minecraft user so they can access to the tavern_key secret (needed to open the iron door).
