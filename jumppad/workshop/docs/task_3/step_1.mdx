...
- Configure sshd for to trust the Vault server public keys for your namespace
...
```
you can browse the playbook files in the `ansible` directory. To view the code for each of the referenced tasks in the playbook.
