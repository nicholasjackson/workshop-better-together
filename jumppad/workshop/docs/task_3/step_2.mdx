...
update the terraform.auto.tfvars using cli or vscode, or if your more comfortable with vscode you can use that from the workshop tab.
 the vscode editor to make the required updates
...
aap_username="<your_team_name>_admin" replace <your_team_name> with your team name
