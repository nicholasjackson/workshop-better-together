...
<a href="https://developer.hashicorp.com/hcp/docs/vault/get-started/manage-public-access" target="_blank">Manage public network access</a>

## Login to HCP Vault

<Task id="vault_login">
1. Click on Instruqt terminal tab to begin.
2. The <a href="https://developer.hashicorp.com/vault/docs/commands" target="_blank">Vault CLI</a> is pre-installed in the terminal. However, you'll need to set the environment variable `VAULT_ADDR` to the HCP Vault address.
