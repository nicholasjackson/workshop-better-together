...
Machine credentials are associated with an Ansible Job templates and allow for authenticated access to a host machine and execution of a Ansible playbook.
