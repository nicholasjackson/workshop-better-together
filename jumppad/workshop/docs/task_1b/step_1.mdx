...
to go. Your VAULT_ADDR should be pre-set as 
...
4. Login using the `userpass` method with the team's credentials by using the following command. TEAM_NAME should be already exported to env in step 2.
