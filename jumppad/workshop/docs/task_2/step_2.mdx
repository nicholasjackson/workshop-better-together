...
1. From the left menu, click Automation Execution, then Infrastructure, and select Credentials. Locate `minecraft_ssh_credentials`, which has been preconfigured, but you will need to enter your SSH keypair to complete the setup.
