...
3. Copy the Full UUID value and use it as the password for the user. Export as env vars as below:
...
4. Create a user for your Minecraft user in the `userpass` authentication method. You will also assign the `tavern` policy to the user.
