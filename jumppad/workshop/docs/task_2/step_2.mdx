...
secret_id_ttl         0s
```
3. Copy the Role ID and Secret ID as you will need them in the next task.
</Task>
...
2. Enter the username allocated to your team and the password (stored in Vault, the Vault path is `secrets/app`)
...
<Solution title="Solution: AAP inteface credentials">
