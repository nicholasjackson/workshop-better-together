...
1. ✅ Built a secure Minecraft server image using Packer and Ansible.
2. ✅ Deployed the new image with Terraform, integrating with AAP provider to create inventory, register server, and automate user access.
3. ✅ Configured AAP credentials and variables for server management.
4. ✅ Validated that the server is running and users can connect.
5. ✅ Verified that users are whitelisted and can successfully connect in Minecraft.
