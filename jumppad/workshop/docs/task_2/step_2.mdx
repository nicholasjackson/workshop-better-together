...
Vault's <a href="https://www.vaultproject.io/docs/auth/approle" target="_blank">AppRole</a> authentication (auth) method is used to enable AAP to authenticate with Vault using a Role ID and Secret ID.
