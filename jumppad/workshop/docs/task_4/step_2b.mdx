...
### 22. Each ship is forged in a distinct harbor—how does Packer define the place (AWS, Azure, local) to craft an image?

---

### 23. After forging the vessel, some final touches be needed—like compressing or uploading. Which part of Packer does that?
---
...
### 27. In this strange land, the host fetches its own instructions from a remote repository—what command performs this reversal?
...
### 29. Store yer state on distant shores—how do ye configure Terraform to keep the ledger in S3 or Consul?
